              ...
              <Dialog.Panel className="relative w-full max-w-lg transform overflow-hidden rounded-2xl bg-themeDialogBlack p-4 text-left align-middle shadow-xl transition-all md:p-6">
                ...
                <div className="flex flex-col gap-8">
                  ...
                  <div className="flex flex-col gap-6">
                      ...
                      >
                        <div className="flex flex-grow items-center gap-2 md:gap-4">
                          ...
                          <span className="flex-grow">
                            {twitter ? 'Twitter Connected' : 'Connect Twitter'}
                          </span>
                          {twitter && (
                            <span className="text-xs text-white/40">
                              (
                      ...
                      >
                        <div className="flex flex-grow items-center gap-2 md:gap-4">
                          ...
                          <a
                            ...
                            className="font-bold text-themeLightViolet"
                          >
                            Join Group
                          </a>
                        </div>
                    ...
                    {/*        target="_blank"*/}
                    {/*        rel="noreferrer noopener"*/}
                    {/*        className="text-xs font-bold text-themeBlue"*/}
                    {/*      >*/}
                    {/*        /!* Join the group and press refresh below *!/*/}
                    ...
                    {/*  <div*/}
                    {/*    className={`flex h-14 items-center ${*/}
                    {/*      !isLoggedIn || telegram ? 'opacity-50' : ''*/}
                    {/*    } justify-between gap-4 rounded border-2 border-white/10 px-2 text-left md:px-3`}*/}
                    {/*  >*/}
                    {/*    <div className="flex flex-grow items-center gap-2 md:gap-4">*/}
                    {/*      <LiaTelegramPlane className="text-3xl text-themeBorderBlue" />*/}
                    {/*      <input*/}
                    {/*        type="text"*/}
                    {/*        value={telegramInfo}*/}
                    {/*        placeholder="Your Telegram Username"*/}
                    {/*        disabled={!isLoggedIn || telegram}*/}
                    ...
                    {/*  /!* {!telegramInfo && (*/}
                    {/*    <button*/}
                    {/*      disabled={telegram || !isLoggedIn}*/}
                    {/*      onClick={telegramAuth}*/}
                    {/*      className="relative flex h-14 items-center justify-between gap-2 rounded border-2 border-white/10 px-2 text-left disabled:opacity-50 md:gap-4 md:px-3"*/}
                    {/*    >*/}
                    {/*      <div className="flex flex-grow items-center gap-2 md:gap-4">*/}
                    {/*        <LiaTelegramPlane className="text-3xl text-themeBorderBlue" />*/}
                    {/*        <span className="flex-grow">Connect Telegram</span>*/}
                    {/*      </div>*/}
                    {/*      {telegram && (*/}
                    {/*        <span className="flex h-6 w-6 items-center justify-center rounded-full bg-green-500">*/}
                    {/*          <MdDone className="text-xl" />*/}
                    ...
                    {/*    <div*/}
                    {/*      // onClick={telegramAuth}*/}
                    {/*      className="relative flex h-14 items-center justify-between gap-2 rounded border-2 border-white/10 px-2 text-left md:gap-4 md:px-3"*/}
                    {/*    >*/}
                    {/*      <Link*/}
                    {/*        href={'https://t.me/+8S5DvUOEb2RjMWY1'}*/}
                    {/*        target="_blank"*/}
                    {/*        rel="noreferrer noopener"*/}
                    {/*        className="flex flex-grow items-center gap-2 md:gap-4"*/}
                    {/*      >*/}
                    {/*        <LiaTelegramPlane className="text-3xl text-themeBorderBlue" />*/}
                    {/*        <span className="flex-grow">*/}
                    {/*          {telegram ? 'Telegram Connected' : 'Join Group'}*/}
                    {/*        </span>*/}
                    {/*        {telegramInfo && (*/}
                    {/*          <span className="text-xs text-white/40">*/}
                    {/*            (*/}
                    {/*            {userInfo?.telegram*/}
                    {/*              ? userInfo?.telegram.username*/}
                    ...
                    {/*          <IoRefreshCircleOutline className="text-3xl text-themeBorderBlue" />*/}
                    {/*        </button>*/}
                    {/*      )}*/}
                    {/*    </div>*/}
                    {/*  )} *!/*/}
                    ...
                    <div className="flex flex-col gap-1">
                      ...
                      >
                        {user?.email === undefined ? (
                          ...
                          <div className="flex flex-grow items-center gap-2 text-gray-400 md:gap-4">
                            <HiOutlineMail className="text-3xl text-themeBorderBlue" />
                            {user?.email.address}
                          </div>
                        )}
